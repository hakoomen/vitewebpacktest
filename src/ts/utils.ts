...
export * from "./extra"; //  sideEffect only import (this should work no matter what but in webpack sideEffects property in package.json overrides the language behavior which is horrible)
